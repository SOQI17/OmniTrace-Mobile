                ...
                <div className="flex flex-col items-center justify-center h-full space-y-4 animate-fadeIn">
                    <div className="bg-white p-6 rounded-2xl shadow-xl text-center max-w-md border border-slate-200 w-full">
                        <div className="mb-4">
                            ...
                            <p className="text-xs text-slate-400 mt-2">Haz clic abajo para activar la cámara.</p>
                        </div>

                        <div className="relative">
                            {/* Contenedor del video */}
                            <div id="reader" className="overflow-hidden rounded-xl bg-slate-900 border-2 border-indigo-500 shadow-inner" style={{ width: '100%', minHeight: '300px' }}></div>
                        ...
                        <button 
                            ...
                            onClick={async () => {
                                try {
                                    // Forzamos la carga de la librería
                                    ...
                                    const playSuccessSound = () => {
                                        ...
                                        } catch (e) { console.error("Audio no soportado", e); }
                                    };
                                    ...
                                    alert("No se pudo activar la cámara. Revisa si estás en HTTPS.");
                                }
                            }}
